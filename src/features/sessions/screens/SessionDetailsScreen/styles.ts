...
export const createStyles = (theme: Theme) =>
  StyleSheet.create({
    ...
    // Poster detail view (fuller layout)
    posterDetailScroll: {
      flex: 1,
    },
    posterDetailContent: {
    ...
    posterDetailUrgency: {
      ...
      backgroundColor: theme.colors.warning?.background ?? theme.colors.primary.light,
      marginBottom: theme.spacing[3],
    },
    ...
    posterDetailCountsRow: {
      flexDirection: 'row',
      gap: theme.spacing[3],
    },
    posterDetailCountCard: {
      flex: 1,
      backgroundColor: theme.colors.background.primary,
      borderRadius: theme.borderRadius.lg,
      padding: theme.spacing[4],
